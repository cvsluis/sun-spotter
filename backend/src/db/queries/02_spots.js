...
const getSpotVisits = function (spotID) {
  const query = `SELECT visits.id as id, users.profile_pic, users.first_name as first_name, users.last_name as last_name, visits.time_stamp as date, visits.image_url as image_url, visits.description 
